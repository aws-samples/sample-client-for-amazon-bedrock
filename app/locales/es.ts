...
const es: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} mensajes con Chat`,
    Actions: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Agregar forzosamente un prompt de sistema simulado de Chat al comienzo de la lista de mensajes en cada solicitud",
    },
    Update: {
