...
const cs: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} zpráv s Chat`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Zpráva z Chat",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Vynutit přidání simulovaného systémového promptu Chat na začátek seznamu zpráv každého požadavku",
    },
    Update: {
