 ...
 */
class WatsonxAI extends llms_1.LLM {
    static lc_name() {
        return "WatsonxAI";
    }
    get lc_secrets() {
    ...
    constructor(fields) {
        ...
        this.ibmCloudApiKey =
            fields?.ibmCloudApiKey ?? (0, env_1.getEnvironmentVariable)("IBM_CLOUD_API_KEY");
        this.projectId =
            fields?.projectId ?? (0, env_1.getEnvironmentVariable)("WATSONX_PROJECT_ID");
        this.endpoint =
