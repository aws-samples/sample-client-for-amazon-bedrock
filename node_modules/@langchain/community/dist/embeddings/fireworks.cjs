...
exports.FireworksEmbeddings = void 0;
 ...
 */
class FireworksEmbeddings extends embeddings_1.Embeddings {
    /**
    ...
    constructor(fields) {
        ...
        const apiKey = fieldsWithDefaults?.apiKey || (0, env_1.getEnvironmentVariable)("FIREWORKS_API_KEY");
        if (!apiKey) {
