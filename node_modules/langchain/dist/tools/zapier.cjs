 ...
 */
class ZapierNLAWrapper extends serializable_1.Serializable {
    get lc_secrets() {
        return {
    ...
    constructor(params) {
        ...
        const oauthAccessToken = zapierNlaOAuthAccessToken ??
            (0, env_1.getEnvironmentVariable)("ZAPIER_NLA_OAUTH_ACCESS_TOKEN");
        const apiKey = zapierNlaApiKey ?? (0, env_1.getEnvironmentVariable)("ZAPIER_NLA_API_KEY");
        ...
        this.caller = new async_caller_1.AsyncCaller(typeof params === "string" ? {} : params ?? {});
    }
    _getHeaders() {
        const headers = {
 ...
 */
class ZapierNLARunAction extends tools_1.Tool {
    static lc_name() {
    ...
    constructor(apiWrapper, actionId, zapierDescription, paramsSchema, params) {
        ...
        this.description = (0, prompts_1.renderTemplate)(zapierNLABaseDescription, "f-string", {
